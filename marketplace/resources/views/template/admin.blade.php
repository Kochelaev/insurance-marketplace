        ...
        <ul class="list-unstyled components">
            ...
            @if (Route::has('admin.home'))
                <li class="nav-item pl-3">
                    <a href="{{ route('admin.home') }}">{{ __('Мой профиль') }}</a>
                </li>
            @endif

            @if (Route::has('admin.users'))
                <li class="nav-item pl-3">
                    <a href="{{ route('admin.users') }}">{{ __('Пользователи') }}</a>
                </li>
            @endif

            @if (Route::has('admin.companys'))
                <li class="nav-item pl-3">
                    <a href="{{ route('admin.companys') }}">{{ __('Компании') }}</a>
                </li>
            @endif
            ...
            @if (Route::has('admin.mail'))
                <li class="nav-item pl-3">
                    <a href="{{ route('admin.mail') }}">{{ __('Почта') }}</a>
                </li>
            @endif
